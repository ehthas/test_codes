...
#pose_target.position.x = 0.153
#pose_target.position.y = 0.223
#pose_target.position.z = 0.552
#pose_target.orientation.x = 0.568
#pose_target.orientation.y = -0.514
#pose_target.orientation.z = 0.412
#pose_target.orientation.w = 0.494
...
##Planning to a Pose Goal
pose_target=geometry_msgs.msg.Pose()
pose_target.position.x = 0.194
pose_target.position.y = -0.227
pose_target.position.z = 0.510
pose_target.orientation.x = 0.998
pose_target.orientation.y = -0.020
pose_target.orientation.z = 0.022
pose_target.orientation.w = -0.060
arm_left_torso.set_pose_target(pose_target)
