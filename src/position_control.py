...
def convert_to_message(T):
	...
	t.position.x = 0.194               #position[0]
	t.position.y = -0.230              #position[1]
	t.position.z = 0.510               #position[2]
	t.orientation.x = 0.998            #orientation[0]
	t.orientation.y = -0.020           #orientation[1]
	t.orientation.z = 0.022            #orientation[2]
	t.orientation.w = -0.060           #orientation[3]        
	return t
...
class MoveArm(object):
	...
	def __init__(self):
		...
		self.q_min = []
		self.q_max = []
		self.q_min.append(-1.11);self.q_max.append(1.50)
		self.q_min.append(-1.11);self.q_max.append(1.50)
		self.q_min.append(-0.72);self.q_max.append(3.86)
		self.q_min.append(-0.32);self.q_max.append(2.29)
		self.q_min.append(-2.07);self.q_max.append(2.07)
		self.q_min.append(-1.39);self.q_max.append(1.39)
		self.q_min.append(-1.39);self.q_max.append(1.39)
		# How finely to sample each joint
		#self.q_sample = [0.05, 0.05, 0.05, 0.1, 0.1, 0.1, 0.1]
		self.joint_names = ["arm_left_1_joint",
							"arm_left_2_joint",
							"arm_left_3_joint",
							"arm_left_4_joint",
							"arm_left_5_joint",
		...
		self.group_name = "arm_left_torso"
